...
schedule:
  ...
  - duration: 30
    ...
    title: Testing code with Property Based Testing

  - duration: 30
    type: speaker
    speakers:
      - name: Jeff Bennett
        url: https://twitter.com/DigitalSplash
        company: Digital Splash Media
    title: Intro to the visualization framework D3
